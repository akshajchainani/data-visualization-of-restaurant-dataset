...
df_data = pd.read_csv(r"C:\Users\OneDrive\Documents\project data analysis\Power bi project\tva project\raw data\65fad3f41f754_Data_Set.csv", encoding='unicode_escape')
print(df_data)


# Loading excel file of country code using pandas

df_country = pd.read_excel(r"C:\Users\OneDrive\Documents\project data analysis\Power bi project\tva project\ raw data\Country-Code.xlsx")
print(df_country)
